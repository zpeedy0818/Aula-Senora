package aulasenora.messaging.dto;
...
public class MensajeAulaDTO {
    ...
    public MensajeAulaDTO(Long id, String contenido, String remitenteNombre, Long remitenteId,
                          String remitenteUsername, String remitenteRol, LocalDateTime fechaEnvio) {
        this.id = id;
